...
export const BREADCRUMB_PATH_USERS = 'mod-users.MODULE_TITLE';

export const PATH_MERMA = 'merma';
export const TITLE_PATH_MERMA = 'Merma';
export const BREADCRUMB_PATH_MERMA = 'mod-merma.MODULE_TITLE';
...
export const PATH_ALERT = 'alerts';
export const TITLE_PATH_ALERT = 'Alertas';    
export const BREADCRUMB_PATH_ALERT = 'mod-alerts.MODULE_TITLE';
