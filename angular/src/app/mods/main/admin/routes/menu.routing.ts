  ...
  import { BREADCRUMB_PATH_CATALOG, BREADCRUMB_PATH_MODULES, BREADCRUMB_PATH_USERS, PATH_CATALOG, PATH_MODULES, PATH_USERS, TITLE_PATH_CATALOG, TITLE_PATH_MODULES, TITLE_PATH_USERS } from '@mod/main/const/main.const';
