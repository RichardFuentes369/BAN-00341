...
import { MOD_MERMA_PAGE_HISTORICO_PERIODO, MOD_MERMA_PAGE_HISTORICO_REGISTRO } from '@mod/merma/const/loss.conts';
...
export class MesesMermaComponent implements OnInit, OnDestroy {
  ...
  endPoint = 'registro-mermas/obtener-periodo-meses'
