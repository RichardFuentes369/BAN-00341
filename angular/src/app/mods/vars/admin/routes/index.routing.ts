...
import { BREADCRUMB_PATH_SYSTEM_JSON, BREADCRUMB_PATH_SYSTEM_VAR, PATH_SYSTEM_JSON, PATH_SYSTEM_VAR, TITLE_PATH_SYSTEM_INDEX, TITLE_PATH_SYSTEM_JSON, TITLE_PATH_SYSTEM_VAR } from '@mod/vars/const/vars.const';
import { IndexComponent } from '@mod/vars/admin/pages/index/index.component';

export const VarsRoutes: Routes = [
  {
    path: '',
