...
import { MeFinalPageProfileComponent } from '../final/pages/profile/profile.component';
import { MeFinalPageSettingsComponent } from '../final/pages/settings/settings.component';
