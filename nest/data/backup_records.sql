...
-- Dumping data for table core_project_BAN_00341.mod_permisos_modulo: ~56 rows (approximately)
INSERT INTO `mod_permisos_modulo` (`id`, `nombre`, `permiso`, `tiene_submodulos`, `tiene_permisos`, `descripcion`, `modulo_padre_id`) VALUES
	...
	(63, 'Cargar (excel)', 'cargar_excel', 0, 1, 'Permiso cargar_excel, submodulo productos, modulo catalogo', 38),
	(64, 'Lote', 'lote', 0, 1, 'Modulo lote', NULL),
	(65, 'Ver', 'ver', 0, 1, 'ver', 64),
	(66, 'Crear', 'crear', 0, 1, 'crear', 64),
	(67, 'Editar', 'editar', 0, 1, 'editar', 64),
	(68, 'Eliminar (individual)', 'eliminar_individual', 0, 1, 'eliminar_individual', 64),
	(69, 'Eliminar (multiple)', 'eliminar_multiple', 0, 1, 'eliminar_multiple', 64);

-- Dumping data for table core_project_BAN_00341.mod_permisos_modulo_asignacion: ~46 rows (approximately)
INSERT INTO `mod_permisos_modulo_asignacion` (`id`, `nombre`, `permiso`, `descripcion`, `modulo_padre_id`, `user_id`) VALUES
	...
	(67, 'Eliminar (individual)', 'eliminar_individual', 'Permiso eliminar individual, submodulo administradores, modulo usuarios', 2, 1),
	(69, 'Eliminar (multiple)', 'eliminar_multiple', 'Permiso eliminar multiple, submodulo finales, modulo usuarios', 10, 1),
	(70, 'Cargar (excel)', 'cargar_excel', 'Permiso cargar_excel, submodulo productos, modulo catalogo', 38, 1),
	(73, 'Modulos', 'modulos', 'Modulo modulos', NULL, 1),
	(74, 'Catalogo', 'catalogo', 'Modulo catalogo', NULL, 1),
	(75, 'Merma', 'merma', 'Modulo merma', NULL, 1),
	(76, 'Lote', 'lote', 'Modulo lote', NULL, 1),
	(96, 'Registro merma', 'registro_merma', 'Permiso registro_merma, modulo merma', 44, 1);

-- Dumping data for table core_project_BAN_00341.mod_usuarios_admin: ~12 rows (approximately)
INSERT INTO `mod_usuarios_admin` (`id`, `firstName`, `lastName`, `email`, `password`, `isActive`) VALUES
	...
	(3, 'Admin3', 'Admin3', 'admin2@correo.com', 'Qwerty9601', 0),
	(4, 'Admin4', 'Admin4', 'admin3@correo.com', 'Qwerty9601', 0),
	(5, 'Admin5', 'Admin5', 'admin4@correo.com', 'Qwerty9601', 0),
	(6, 'Admin6', 'Admin6', 'admin5@correo.com', 'Qwerty9601', 0),
	(7, 'Admin7', 'Admin7', 'admin6@correo.com', 'Qwerty9601', 0),
	(8, 'Admin8', 'Admin8', 'admin7@correo.com', 'Qwerty9601', 0),
	(9, 'Admin9', 'Admin9', 'admin8@correo.com', 'Qwerty9601', 0),
	(10, 'Admin10', 'Admin10', 'admin9@correo.com', 'Qwerty9601', 0),
	(11, 'Admin11', 'Admin11', 'admin10@correo.com', 'Qwerty9601', 0),
	(12, 'Admin12', 'Admin12', 'admin11@correo.com', 'Qwerty9601', 0);
